...
happyExpList = Happy_Data_Array.listArray (0,37) ([33280,1024,4096,0,16384,8192,49152,0,4,64,32,12,24,128,2048,64,0,0,0,32768,6144,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","BabbleG","Terms","Elems","Elem","L","T","NT","':'","';'","prob","nprob","'|'","'_'","%eof"]
        bit_start = st * 17
        bit_end = (st + 1) * 17
...
action_7 (12) = happyShift action_20
...
action_10 (8) = happyGoto action_17
action_10 _ = happyReduce_11

action_11 (9) = happyShift action_10
action_11 (10) = happyShift action_11
...
action_19 (7) = happyGoto action_8
action_19 (8) = happyGoto action_9
...
happyReduction_3 (HappyTerminal (ChainTerm happy_var_1))
	 =  HappyAbsSyn5
...
happyReduction_7 (HappyTerminal (Nprob happy_var_3))
	_
...
happyReduction_11 (HappyTerminal (ChainTerm happy_var_1))
	 =  HappyAbsSyn8
		 ([([Term happy_var_1])]
	)
...
happyReduction_12 (HappyTerminal (ChainNTerm happy_var_1))
	 =  HappyAbsSyn8
		 ([([NoTerm happy_var_1])]
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	ChainTerm happy_dollar_dollar -> cont 9;
	ChainNTerm happy_dollar_dollar -> cont 10;
	Colon -> cont 11;
	SemiColon -> cont 12;
	Prob -> cont 13;
	Nprob happy_dollar_dollar -> cont 14;
	Pipe -> cont 15;
	UnderScore -> cont 16;
	_ -> happyError' ((tk:tks), [])
	}
